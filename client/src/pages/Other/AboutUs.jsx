  ...
  return (
    <div className=' bg-white menu-background'>
      <div className='section-container  '>
        ...
        <div className='md:w-3/5 space-y-7  bg-blue-200 p-4 rounded-2xl mt-32'>
            <h2 className='text-3xl font-semibold text-slate-700'>About Us</h2>
            <p className='text-gray-800'>
            QuickCuisine is a family-owned restaurant that has been serving the Indian community for over 30 years. We specialize in Indian cuisine, and we are proud to offer a wide variety of dishes from all over the country.
            </p>
            <p className='text-gray-800'>
            ...
            <p className='text-gray-800'>
            We hope you enjoy your visit to QuickCuisine
            </p>
        </div>
