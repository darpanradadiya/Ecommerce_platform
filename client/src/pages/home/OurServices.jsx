        ...
        <div className="md:w-1/2">
          <div className="grid sm:grid-cols-2 grid-cols-1 gap-8 items-center">
            {serviceLists.map((service) => (
              <div
                key={service.id}
                className="bg-blue-200 shadow-xl border-none rounded-sm py-5 px-4 text-center space-y-2 text-[#CA761C] cursor-pointer hover:border hover:border-indigo-600 transition-all duration-200"
