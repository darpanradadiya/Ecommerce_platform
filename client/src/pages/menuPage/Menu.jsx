      ...
      <div className="section-container mt-20 bg-gradient-to-r menu-background bg-white">
        <div className="  py-30 flex flex-col md:flex-row-reverse justify-between items-center gap-6">
          ...
          <div className='md:w-1/2 space-y-7 px-4'>
            <div className='  rounded-3xl shadow-xl  p-8 px-10 bg-blue-200'>
              
              <p className='text-gray-600 mt-4'>
             <span className=' text-2xl'>"</span> <span className=' text-lg'> Welcome to QuickCuisine, your ultimate culinary destination in India! Explore our enticing menu crafted by our talented chef, where you can easily browse, sort, and add delectable dishes to your cart for a seamless online ordering experience. Indulge in a symphony of flavors right at your fingertips!</span> <span className='text-2xl'>"</span>
              </p>
